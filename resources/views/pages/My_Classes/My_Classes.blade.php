    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <br><br>
                ...
                <form action="{{ url(LaravelLocalization::getCurrentLocale() . '/' .'classrooms/filter_classes') }}" method="POST">
                    {{ csrf_field() }}
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- edit_form -->
                                            <form action="{{ url(LaravelLocalization::getCurrentLocale() . '/' .'classrooms/update')}}" method="post">
                                                {{ method_field('patch') }}
                                                @csrf
                                                <div class="row">
                                                    <div class="col">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class=" row mb-30" action="{{ url(LaravelLocalization::getCurrentLocale() . '/' .'classrooms') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="repeater">
...
<div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url(LaravelLocalization::getCurrentLocale() . '/' .'classrooms/delete_all') }}" method="POST">
                {{ csrf_field() }}
                <div class="modal-body">
                    {{ trans('My_Classes_trans.Warning_Grade') }}
