            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{url('teachers/create')}}" class="btn btn-success btn-sm" role="button" aria-pressed="true">{{ trans('Teacher_trans.Add_Teacher') }}</a><br><br>
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($Teachers as $Teacher)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url(LaravelLocalization::getCurrentLocale() . '/' . 'teachers/ ' .  $Teacher->id . '/edit')}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
