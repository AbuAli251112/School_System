                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- add_form -->
                                            <form action="{{ url(LaravelLocalization::getCurrentLocale() . '/' .'grades/update')}}" method="post">
                                                {{ method_field('patch') }}
                                                @csrf
                                                <div class="row">
                                                    <div class="col">
                            ...
                            <div class="modal fade" id="delete{{ $Grade->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url(LaravelLocalization::getCurrentLocale() . '/' .'grades/destroy') }}" method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- add_form -->
                <form action="{{ url(LaravelLocalization::getCurrentLocale() . '/' . 'grades') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col">
