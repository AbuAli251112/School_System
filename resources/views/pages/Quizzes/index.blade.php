                ...
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                @if (auth("web")->check())
                                    <a href="{{url('quizzes/create')}}" class="btn btn-success btn-sm" role="button" aria-pressed="true">اضافة اختبار جديد</a><br><br>
                                @endif
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>الصف الدراسي</th>
                                                <th>القسم</th>
                                                @if(auth("web")->check()) <th>العمليات</th> @endif
                                            </tr>
                                        </thead>
                                        <tbody>
                                        @foreach($quizzes as $quizze)
                                            <tr>
                                                ...
                                                @if (auth("web")->check())
                                                    <td>
                                                        <a href="{{url('quizzes/' . $quizze->id . '/edit')}}"
