    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{url('section')}}">{{trans('main_trans.List_sections')}}</a></li>
            </ul>
        </li>
            ...
            <ul id="students-menu" class="collapse">
                ...
                <li>
                    ...
                    <ul id="Students_upgrade" class="collapse">
                        <li> <a href="{{url('promotion')}}">{{trans('main_trans.add_Promotion')}}</a></li>
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{url(LaravelLocalization::getCurrentLocale() . '/fees')}}">الرسوم الدراسية</a> </li>
                <li> <a href="{{url(LaravelLocalization::getCurrentLocale() . '/fees_invoices')}}">الفواتير</a> </li>
                <li> <a href="{{url(LaravelLocalization::getCurrentLocale() . '/receipt_students')}}">سندات القبض</a> </li>
                <li> <a href="{{url(LaravelLocalization::getCurrentLocale() . '/processingfee')}}">استبعاد رسوم</a> </li>
                <li> <a href="{{url(LaravelLocalization::getCurrentLocale() . '/payment_students')}}">سندت الصرف</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{url('attend')}}">قائمة الطلاب</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{url('subjects')}}">قائمة المواد</a> </li>
            </ul>
        </li>
