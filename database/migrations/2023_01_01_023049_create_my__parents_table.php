...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('my__parents', function (Blueprint $table) {
            ...
            $table->foreign('Nationality_Father_id')->references('id')->on('nationalites')->onDelete('cascade')->onUpdate('cascade');
            ...
            $table->foreign('Nationality_Mother_id')->references('id')->on('nationalites')->onDelete('cascade')->onUpdate('cascade');
